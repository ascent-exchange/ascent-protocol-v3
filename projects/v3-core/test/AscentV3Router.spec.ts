...
describe('AscentV3Pool', () => {
  ...
  let pool0: MockTimeAscentV3Pool
  let pool1: MockTimeAscentV3Pool
  ...
  let swapTargetCallee: TestAscentV3Callee
  let swapTargetRouter: TestAscentV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeAscentV3Pool, any]> => {
