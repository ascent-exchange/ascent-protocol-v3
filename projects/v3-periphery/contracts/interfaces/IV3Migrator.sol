...
/// @title V3 Migrator
/// @notice Enables migration of liqudity from AscentExchange v2-compatible pairs into AscentExchange v3 pools
interface IV3Migrator is IMulticall, ISelfPermit, IPoolInitializer {
    struct MigrateParams {
        address pair; // the AscentExchange v2-compatible pair
