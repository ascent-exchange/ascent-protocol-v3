...
import '@ascentexchange/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IAscentV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IAscentV3Pool;
    ...
    function ascentV3SwapCallback(
        ...
        IAscentV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IAscentV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
