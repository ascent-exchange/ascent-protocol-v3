...
import '@ascentexchange/v3-core/contracts/interfaces/callback/IAscentV3FlashCallback.sol';
...
/// @notice An example contract using the AscentExchange V3 flash function
contract PairFlash is IAscentV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `AscentV3FlashCallback`
