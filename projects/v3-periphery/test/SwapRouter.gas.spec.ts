import { abi as IAscentV3PoolABI } from '@ascentexchange/v3-core/artifacts/contracts/interfaces/IAscentV3Pool.sol/IAscentV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IAscentV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain-types'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IAscentV3Pool, IAscentV3Pool, IAscentV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IAscentV3PoolABI, wallet)) as [
      IAscentV3Pool,
      IAscentV3Pool,
      IAscentV3Pool
    ]
  ...
  let pools: [IAscentV3Pool, IAscentV3Pool, IAscentV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it.skip('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestAscentV3Callee')
